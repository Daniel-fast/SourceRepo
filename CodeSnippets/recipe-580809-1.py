...
doc = fitz.open("EquacoesNaoLineares.pdf")           # or new: fitz.open(), followed by insertPage()
...
#             \n<- This forced line break will also appear.\t
#             Now a very long word: abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.
#             \nIt will be broken into pieces."""

text = "This text will only appear in the rectangle"
